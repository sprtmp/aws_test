...
@include('header')
    <main class="m-0 position-relative">
        ...
        <div class="vid-content">
            ...
            <h1 data-aos="fade-up">lepidoptera of india</h1>
    ...
    <section>
        <ul class="nav nav-pills mb-3 justify-content-center mt-5 mb-4" id="pills-tab" role="tablist">
            <li class="nav-item" role="presentation" data-aos="fade-up">
                <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-tab1" type="button" role="tab" aria-controls="pills-home" aria-selected="true">Latest Lepidoptera</button>
            </li>
            <li class="nav-item" role="presentation" data-aos="fade-up">
