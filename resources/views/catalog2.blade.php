...
.action-widh{
    ...
    <main>
        ...
        <div class="search-area mb-5" data-aos="fade-up" data-aos-easing="linear">
            <div class="container-fluid">
                <form class="row d-flex justify-content-center" action="{{ route('catalouge') }}" method="GET">
                <div class="col-lg-3 p-0"></div>
                <div clas="col-sm-9">
                    <h4 style="margin-left: 7.7%; color: #fff;">Advance Search</h4>
                </div>
        ...
        <div class="table-structure px-4" data-aos="fade-up">
            ...
            <table id="example" class="display" style="width:100%">
                <thead>
                    <tr>
                        <!--<th>#</th>-->
                        <th class="action-widh">Super Family</th>
                        <th>Family</th>
                        <th>Subfamily</th>
                        <th>Tribe</th>
                        <th>Genus</th>
