...
<body class="main-body">
    <header class="container-fluid fixed-top">
        ...
        <div class="bottom-part  navbar-collapse" id="navbarTogglerDemo02">
         ...
         <ul>
            <!-- <li><a onClick="ActiveMenu(0)" href="{{url('/')}}">Home</a></li>
            ...
            <li><a href="{{ url('/introduction') }}" class="{{ request()->is('introduction') ? 'active' : '' }}">Introduction</a></li>
            <li><a href="{{ url('/catalouge') }}" class="{{ request()->is('catalouge') ? 'active' : '' }}">Catalogue</a></li>
            <li><a href="{{ url('/distribution') }}" class="{{ request()->is('distribution') ? 'active' : '' }}">Distribution</a></li>
            <li><a href="{{ url('/statistics') }}" class="{{ request()->is('statistics') ? 'active' : '' }}">Statistics</a></li>
            <li><a href="{{ url('/gallery') }}" class="{{ request()->is('gallery') ? 'active' : '' }}">Gallery</a></li>
            <li><a href="{{ url('/reference') }}" class="{{ request()->is('reference') ? 'active' : '' }}">References</a></li>
